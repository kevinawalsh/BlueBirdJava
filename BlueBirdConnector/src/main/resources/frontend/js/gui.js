...
$.connectedDevListRefresh = function() {
  ...
  $.each(connectedDeviceList, function(i, item) {
    ...
    var el = $(
      ...
      // Calibration button
      "                   <a title=\"Calibrate orientation magnetometer\" class=\"button\" href=\"#\" onmouseenter=\"tts(\'" + ttsCalibrate + "\')\" onclick=\"return confirm(\'Calibration of the accelerometer/magnetometer takes time and can\\\'t be cancelled, are you sure you want to do it now?\') && launchCalibrate(\'" + devLetter + "\', \'" + deviceName + "\', \'" + item.hasV2 + "\');\"><span class=\"button-calibrate fa-stack fa-2x\">" +
